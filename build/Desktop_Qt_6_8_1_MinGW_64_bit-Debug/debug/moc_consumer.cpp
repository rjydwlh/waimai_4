...
static constexpr auto qt_meta_stringdata_ZN8consumerE = QtMocHelpers::stringData(
    "consumer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8consumerE[] = {
...
Q_CONSTINIT const QMetaObject consumer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8consumerE.offsetsAndSizes,
    qt_meta_data_ZN8consumerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8consumerE_t,
        // Q_OBJECT / Q_GADGET
...
void *consumer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8consumerE.stringdata0))
