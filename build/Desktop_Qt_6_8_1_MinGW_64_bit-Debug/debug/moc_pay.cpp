...
static constexpr auto qt_meta_stringdata_ZN3payE = QtMocHelpers::stringData(
    "pay",
...
Q_CONSTINIT static const uint qt_meta_data_ZN3payE[] = {
...
Q_CONSTINIT const QMetaObject pay::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3payE.offsetsAndSizes,
    qt_meta_data_ZN3payE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3payE_t,
        // Q_OBJECT / Q_GADGET
...
void *pay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3payE.stringdata0))
